...
import com.example.ptnet.HTTPReassembly
import com.example.ptnet.HTTPReassembly.ReassemblyListener
...
class ConnectionDescriptor : Serializable {
    ...
    fun processUpdate(update: ConnectionUpdate) {
        ...
        if ((update.updateType and ConnectionUpdate().UPDATE_STATS) != 0) {
            ...
            if ((status == ConnectionDescriptor().CONN_STATUS_CLOSED) && (decryptionError != null)) {
