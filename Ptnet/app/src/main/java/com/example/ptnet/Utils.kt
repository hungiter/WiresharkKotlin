...
object Utils {
    ...
    fun getMemoryStats(context: Context): String {
        ...
        return ((("""${
            ((("[Runtime] free: " + Utils.formatBytes(runtime.freeMemory())).toString() + ", max: " + Utils.formatBytes(
                runtime.maxMemory()
            )).toString() + ", allocated: " + Utils.formatBytes(runtime.totalMemory())).toString() + ", available: " + Utils.formatBytes(
                heapAvailable
            )
        }, low=$heapLow
[MemoryState] pid: ${memState.pid}, trimlevel: ${trimlvl2str(memState.lastTrimLevel)}""".toString() +
                "\n[MemoryInfo] available: " + Utils.formatBytes(memoryInfo.availMem)).toString() + ", total: " + Utils.formatBytes(
            memoryInfo.totalMem
        )).toString() + ", lowthresh: " + Utils.formatBytes(memoryInfo.threshold)).toString() + ", low=" + memoryInfo.lowMemory +
    ...
    fun getLocalIPAddress(context: Context): String {
        ...
        val wifiIp: String = getLocalWifiIpAddress(context)!!
