package com.example.ptnet.services
...
import com.example.ptnet.AppsResolver
import com.example.ptnet.ConnectionsRegister
import com.example.ptnet.MainActivity
import com.example.ptnet.MitmReceiver
import com.example.ptnet.PCAPdroid
import com.example.ptnet.R
import com.example.ptnet.Utils
import com.example.ptnet.Utils.PrivateDnsMode
import com.example.ptnet.Utils.getIntentFlags
import com.example.ptnet.Utils.showToastLong
import com.example.ptnet.Utils.trimlvl2str
import com.example.ptnet.interfaces.PcapDumper
import com.example.ptnet.models.Billing
import com.example.ptnet.models.BlacklistDescriptor
import com.example.ptnet.models.Blacklists
import com.example.ptnet.models.Blacklists.NativeBlacklistStatus
import com.example.ptnet.models.Blocklist
import com.example.ptnet.models.CaptureSettings
import com.example.ptnet.models.CaptureStats
import com.example.ptnet.models.ConnectionDescriptor
import com.example.ptnet.models.ConnectionUpdate
import com.example.ptnet.models.FilterDescriptor
import com.example.ptnet.models.MatchList
import com.example.ptnet.models.MatchList.ListDescriptor
import com.example.ptnet.models.MitmAPI
import com.example.ptnet.models.MitmAddon.Companion.getUid
import com.example.ptnet.models.PortMapping
import com.example.ptnet.models.Prefs
import com.example.ptnet.models.Prefs.DumpMode
import com.example.ptnet.models.Prefs.PayloadMode
import com.example.ptnet.pcap_dump.FileDumper
import com.example.ptnet.pcap_dump.HTTPServer
import com.example.ptnet.pcap_dump.UDPDumper
...
class CaptureService : VpnService(), Runnable {
    ...
    private val VpnSessionName = "PCAPdroid VPN"
    private val NOTIFY_CHAN_VPNSERVICE = "VPNService"
    private val NOTIFY_CHAN_MALWARE_DETECTION = "Malware detection"
    private val NOTIFY_CHAN_OTHER = "Other"
    private val VPN_MTU = 10000
...
//                            }
    ...
    private fun getStatusNotification(): Notification {
    ...
    private fun notifyLowMemory(msg: CharSequence?) {
    ...
    private fun handleLinkProperties(linkProperties: LinkProperties?) {
    ...
    private fun signalServicesTermination() {
...
//    }
    ...
    private fun checkBlacklistsUpdates(firstUpdate: Boolean) {
    ...
    private fun updateBlacklistsWork() {
    ...
    private fun getIfname(ifidx: Int): String? {
        if (ifidx <= 0) return ""
...
//                    Log.i(TAG, "newConnections:\n${newConnections.joinToString("\n ")}}")
                    conn_reg!!.newConnections(newConnections)
                }
...
//                    Log.i(TAG, "updateConnections:\n${connectionsUpdates.joinToString("\n ")}")
    ...
    fun isVpnCapture(): Int {
        return if ((isRootCapture() or isPcapFileCapture()) == 1) 0 else 1
    }
    ...
    */
    ...
    private external fun reloadBlocklist(blocklist: ListDescriptor?): Boolean

    private external fun reloadFirewallWhitelist(whitelist: ListDescriptor): Boolean

    private external fun reloadMalwareWhitelist(whitelist: ListDescriptor): Boolean

    private external fun reloadDecryptionList(whitelist: ListDescriptor): Boolean
