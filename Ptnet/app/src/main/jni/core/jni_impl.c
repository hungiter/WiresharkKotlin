...
static void init_jni(JNIEnv *env) {
    ...
    log_d("Start Init JNI");

    /* Classes */
    cls.vpn_service = jniFindClass(env, "com/example/ptnet/services/CaptureService");
    cls.conn = jniFindClass(env, "com/example/ptnet/models/ConnectionDescriptor");
    cls.conn_update = jniFindClass(env, "com/example/ptnet/models/ConnectionUpdate");
    cls.stats = jniFindClass(env, "com/example/ptnet/models/CaptureStats");
    cls.blacklist_status = jniFindClass(env, "com/example/ptnet/models/Blacklists$NativeBlacklistStatus");
    cls.blacklist_descriptor = jniFindClass(env, "com/example/ptnet/models/BlacklistDescriptor");
    cls.matchlist_descriptor = jniFindClass(env, "com/example/ptnet/models/MatchList$ListDescriptor");
    cls.list = jniFindClass(env, "java/util/List");
    cls.arraylist = jniFindClass(env, "java/util/ArrayList");
    cls.payload_chunk = jniFindClass(env, "com/example/ptnet/models/PayloadChunk");

    /* Methods */
    /* Ljava/lang/String;JJJJIIII? -> Input value J for Long, I for Int*/
    ...
    mids.updateConnections = jniGetMethodID(env, cls.vpn_service, "updateConnections", "([Lcom/example/ptnet/models/ConnectionDescriptor;[Lcom/example/ptnet/models/ConnectionUpdate;)V");
    mids.sendStatsDump = jniGetMethodID(env, cls.vpn_service, "sendStatsDump", "(Lcom/example/ptnet/models/CaptureStats;)V");
    ...
    mids.notifyBlacklistsLoaded = jniGetMethodID(env, cls.vpn_service, "notifyBlacklistsLoaded", "([Lcom/example/ptnet/models/Blacklists$NativeBlacklistStatus;)V");
    mids.getBlacklistsInfo = jniGetMethodID(env, cls.vpn_service, "getBlacklistsInfo", "()[Lcom/example/ptnet/models/BlacklistDescriptor;");
    mids.connInit = jniGetMethodID(env, cls.conn, "<init>", "(IIILjava/lang/String;Ljava/lang/String;IIIIIZJ)V");
    mids.connProcessUpdate = jniGetMethodID(env, cls.conn, "processUpdate", "(Lcom/example/ptnet/models/ConnectionUpdate;)V");
    ...
    mids.statsSetData = jniGetMethodID(env, cls.stats, "setDataFromNative", "(Ljava/lang/String;JJJJJIIIIIIIII)V");
    ...
    mids.payloadChunkInit = jniGetMethodID(env, cls.payload_chunk, "<init>", "([BLcom/example/ptnet/models/PayloadChunk$ChunkType;ZJ)V");

    /* Fields */
    fields.bldescr_fname = jniFieldID(env, cls.blacklist_descriptor, "fname", "Ljava/lang/String;");
    fields.bldescr_type = jniFieldID(env, cls.blacklist_descriptor, "type", "Lcom/example/ptnet/models/BlacklistDescriptor$Type;");
    ...
    /* Enums */
    enums.bltype_ip = jniEnumVal(env, "com/example/ptnet/models/BlacklistDescriptor$Type", "IP_BLACKLIST");
    enums.chunktype_raw = jniEnumVal(env, "com/example/ptnet/models/PayloadChunk$ChunkType", "RAW");
    enums.chunktype_http = jniEnumVal(env, "com/example/ptnet/models/PayloadChunk$ChunkType", "HTTP");
    log_d("Success Init JNI");
}

/* ******************************************************* */

JNIEXPORT void JNICALL
Java_com_example_ptnet_services_CaptureService_runPacketLoop(JNIEnv *env, jclass type, jint tunfd,
...
JNIEXPORT void JNICALL
Java_com_example_ptnet_services_CaptureService_stopPacketLoop(JNIEnv *env, jclass type) {
...
JNIEXPORT void JNICALL
Java_com_example_ptnet_services_CaptureService_initPlatformInfo(JNIEnv *env, jclass clazz,
...
//    log_d("PlatformInfo: \n\tVersion: %s\n\tDevice: %s\n\tOS: %s", appver_s, device_s, os_s);
}

/* ******************************************************* */

JNIEXPORT void JNICALL
Java_com_example_ptnet_services_CaptureService_askStatsDump(JNIEnv *env, jclass clazz) {
    if(running)
...
Java_com_example_ptnet_services_CaptureService_getFdSetSize(JNIEnv *env, jclass clazz) {
    return FD_SETSIZE;
}
...
JNIEXPORT void JNICALL
Java_com_example_ptnet_services_CaptureService_setDnsServer(JNIEnv *env, jclass clazz,
                                                               jstring server) {
...
Java_com_example_ptnet_services_CaptureService_getPcapHeader(JNIEnv *env, jclass clazz) {
    pcapdroid_t *pd = global_pd;
...
JNIEXPORT void JNICALL
Java_com_example_ptnet_services_CaptureService_reloadBlacklists(JNIEnv *env, jclass clazz) {
...
JNIEXPORT jint JNICALL
Java_com_example_ptnet_services_CaptureService_getNumCheckedMalwareConnections(JNIEnv *env, jclass clazz) {
...
JNIEXPORT jint JNICALL
Java_com_example_ptnet_services_CaptureService_getNumCheckedFirewallConnections(JNIEnv *env, jclass clazz) {
...
JNIEXPORT void JNICALL
Java_com_example_ptnet_services_CaptureService_setPrivateDnsBlocked(JNIEnv *env, jclass clazz, jboolean to_block) {
...
JNIEXPORT void JNICALL
Java_com_example_ptnet_services_CaptureService_addPortMapping(JNIEnv *env, jclass clazz, jint ipproto,
...
Java_com_example_ptnet_services_CaptureService_reloadBlocklist(JNIEnv *env, jclass clazz,
        jobject ld) {
    pcapdroid_t *pd = global_pd;
...
JNIEXPORT jboolean JNICALL
Java_com_example_ptnet_services_CaptureService_reloadFirewallWhitelist(JNIEnv *env, jclass clazz,
         jobject whitelist) {
    pcapdroid_t *pd = global_pd;
    if(!pd) {
        log_e("NULL pd instance");
...
JNIEXPORT jboolean JNICALL
Java_com_example_ptnet_services_CaptureService_reloadMalwareWhitelist(JNIEnv *env, jclass clazz,
        jobject whitelist) {
    pcapdroid_t *pd = global_pd;
    if(!pd) {
        log_e("NULL pd instance");
...
JNIEXPORT jboolean JNICALL
Java_com_example_ptnet_services_CaptureService_reloadDecryptionList(JNIEnv *env,
...
JNIEXPORT void JNICALL
Java_com_example_ptnet_services_CaptureService_nativeSetFirewallEnabled(JNIEnv *env, jclass clazz, jboolean enabled) {
    pcapdroid_t *pd = global_pd;
    if(!pd) {
        log_e("NULL pd instance");
        return;
...
Java_com_example_ptnet_services_CaptureService_rootCmd(JNIEnv *env, jclass clazz, jstring prog,
                                                          jstring args) {
...
JNIEXPORT void JNICALL
Java_com_example_ptnet_services_CaptureService_setPayloadMode(JNIEnv *env, jclass clazz, jint mode) {
    pcapdroid_t *pd = global_pd;
    if(!pd) {
        log_e("NULL pd instance");
        return;
...
JNIEXPORT jint JNICALL
Java_com_example_ptnet_services_CaptureService_initLogger(JNIEnv *env, jclass clazz,
...
JNIEXPORT jint JNICALL
Java_com_example_ptnet_services_CaptureService_writeLog(JNIEnv *env, jclass clazz,
...
Java_com_example_ptnet_services_CaptureService_getL7Protocols(JNIEnv *env, jclass clazz) {
...
JNIEXPORT void JNICALL
Java_com_example_ptnet_services_CaptureService_dumpMasterSecret(JNIEnv *env, jclass clazz,
                                                                   jbyteArray secret) {
...
JNIEXPORT jboolean JNICALL
Java_com_example_ptnet_services_CaptureService_hasSeenPcapdroidTrailer(JNIEnv *env,
                                                                          jclass clazz) {
